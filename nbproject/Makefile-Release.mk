...
${OBJECTDIR}/crc.o: crc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/crc.o crc.c

${OBJECTDIR}/dbinarytree.o: dbinarytree.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbinarytree.o dbinarytree.c

${OBJECTDIR}/derror.o: derror.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/derror.o derror.c

${OBJECTDIR}/dfile.o: dfile.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dfile.o dfile.c

${OBJECTDIR}/dlist.o: dlist.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dlist.o dlist.c

${OBJECTDIR}/dmemory.o: dmemory.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dmemory.o dmemory.c

${OBJECTDIR}/huffman.o: huffman.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/huffman.o huffman.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c
